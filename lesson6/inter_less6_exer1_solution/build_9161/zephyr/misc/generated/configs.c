...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_TXD_PIN, 27);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_RXD_PIN, 26);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_RTS_PIN, 14);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_UART0_CTS_PIN, 15);
